      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-[repeat(auto-fit,minmax(320px,1fr))]">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <HorizontalBarChart
            ...
            tooltipRenderer={(item) => (
              <>
                <div className="text-xs text-gray-500 mb-1">{getRangeLabel(dateRange[0].startDate, dateRange[0].endDate)}</div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
          ...
          <HorizontalBarChart
            ...
            tooltipRenderer={(item) => (
              <>
                <div className="text-sm text-gray-500 mb-1">{getRangeLabel(dateRange[0].startDate, dateRange[0].endDate)}</div>
