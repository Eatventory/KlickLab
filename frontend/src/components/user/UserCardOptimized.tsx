...
interface UserCardOptimizedProps {
...
// 메모이제이션된 클릭 패턴 아이템
const ClickPatternItem = memo<{ element: { element: string; clicks: number; percentage: number }; index: number }>(
  ({ element, index }) => (
...
// 메모이제이션된 UserCard 컴포넌트
export const UserCardOptimized = memo<UserCardOptimizedProps>(({ user, rank }) => {
  return (
...
UserCardOptimized.displayName = 'UserCardOptimized'; 